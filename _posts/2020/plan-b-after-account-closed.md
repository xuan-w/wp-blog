...
我个人的最爱是 [keybase](https://keybase.io/)。既像 Telegram 一样功能丰富（比 TG 少了一些功能，但多出的功能更多），又像 Signal 一样安全（其实它比 Signal 更安全，不再需要手机号，也很好地解决了 TOFU 问题）。主要的缺点是目前用户太少，另外手机配置太差的话群聊会卡。因为用户太少，现在还没有被防火墙盯上。（keybase 现在已经被 Zoom [收购](https://keybase.io/blog/keybase-joins-zoom)。不过 keybase 的加密算法是公开的，其快照 hash 也在比特币上定期公布，无论是加密安全性还是身份认证的可靠性都与运营者无关，目前不受收购影响。）
