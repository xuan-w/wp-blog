...
为照顾没有技术基础的读者，本文使用脚注对一些词语做了注解，可点击相应链接跳转脚注和跳回原文。如果您觉得本文尚有未尽或难懂之处，欢迎在评论区留言，在 GitHub 上提 [Issue](https://github.com/xuan-w/wp-blog/issues)，或者对这个[文件](https://github.com/xuan-w/wp-blog/edit/master/_posts/2020/where-to-host-my-blog.md)发PR。
